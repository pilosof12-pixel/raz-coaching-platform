...
if (!src.includes(convergenceMarker) || !src.includes(eventMarker) || !src.includes(tacticalEventMarker) || !src.includes(hybridStrengthMarker) || !src.includes(promptBudgetMarker)) {
