...
## Phase 11 additions
This build adds source-grounded mobility and pain/return-to-loading operational rules, a plyometrics/power layer, a less pseudo-precise fatigue model, and dynamic volume logic. Mobility and pain support remain subordinate to strength/performance coaching and do not diagnose or replace clinical care.
