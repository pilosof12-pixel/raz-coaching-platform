...
function fixture() {
  return [
    ...
    '    const raw = await runEngineRaw("prompt");',
...
test('unbenchmarked variation load repair is wired before all coaching QA', () => {
  ...
  assert.match(out, /DETERMINISTIC-UNBENCHMARKED-LOAD-REPAIR/);
});
