...
const INTERNAL_OUTPUT_PATTERNS = Object.freeze([
  ...
  {
    code: 'validator_code',
    re: /\b(?:EXERCISE_HALLUCINATION|EQUIPMENT_VIOLATION|UNILATERAL_UNDERSTIMULATION|INTRADAY_ORDER_VIOLATION|SPORT_DAY_COUPLING_VIOLATION|WEEKLY_MRV_EXCEEDED|SKILL_PREREQ_VIOLATION|SKILL_UNDER_PROGRAMMED|NAMED_GOAL_DIRECT_EXPOSURE_MISSING|TARGET_MODALITY_EXPOSURE_REDUCED|GOAL_COMPONENT_COVERAGE_MISSING|PHASE15_QUALITY_VIOLATION)\b/i,
  },
]);
