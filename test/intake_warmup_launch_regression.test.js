...
import { enrichSpecificWarmups } from '../phase14/engine/specific_warmup_enrichment.js';

const index = fs.readFileSync(new URL('../phase14/public/index.html', import.meta.url), 'utf8');
const polish = fs.readFileSync(new URL('../phase14/public/intake-polish.js', import.meta.url), 'utf8');
const launch = fs.readFileSync(new URL('../phase14/scripts/apply_launch_runtime.mjs', import.meta.url), 'utf8');
