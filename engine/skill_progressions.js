...
const FAMILIES = [
  // ---- PLANCHE ---------------------------------------------------------
  {
    ...
    rungs: [
      { name: "Planche Lean", criterion: { type: "hold_seconds", metric: "planche_lean_hold_s", min: 30, quality: "shoulders_over_wrists" }, dose: { sets: 3, reps: "20-30s", rest: "90s", rir: "1-2", frequency_per_week: 3 }, complementary: ["Pseudo Planche Push-up", "Wrist Prep"] },
      ...
      { name: "Straddle Planche", criterion: { type: "hold_seconds", metric: "straddle_planche_hold_s", min: 10 }, dose: { sets: 5, reps: "5-10s", rest: "3 min", rir: "0-1", frequency_per_week: 2 }, complementary: ["Straddle Planche Push-up"] },
  ...
  // ---- HUMAN FLAG ------------------------------------------------------
  {
    ...
    prerequisites: [
      ...
      { type: "benchmark", metric: "side_plank_hold_s", min: 20, label: "20s straight-arm side plank" },
    ],
    rungs: [
  ...
  // ---- HSPU ------------------------------------------------------------
  {
    ...
    rungs: [
      ...
      { name: "Wall Handstand Push-up Partial", criterion: { type: "reps", metric: "wall_hspu_partial", min: 8 }, dose: { sets: 4, reps: "5-8", rest: "2 min", rir: "1", frequency_per_week: 3 }, complementary: ["Wall Handstand Hold"] },
      { name: "Wall Handstand Push-up", criterion: { type: "reps", metric: "wall_hspu", min: 6 }, dose: { sets: 4, reps: "3-6", rest: "2-3 min", rir: "1", frequency_per_week: 3 }, complementary: [] },
      { name: "Deficit Wall Handstand Push-up", criterion: { type: "reps", metric: "deficit_wall_hspu", min: 5 }, dose: { sets: 4, reps: "3-5", rest: "3 min", rir: "0-1", frequency_per_week: 2 }, complementary: [] },
      { name: "90-Degree Wall Handstand Push-up", criterion: { type: "reps", metric: "wall_90_hspu", min: 3 }, dose: { sets: 5, reps: "1-3", rest: "3 min", rir: "0-1", frequency_per_week: 2 }, complementary: [] },
      { name: "Freestanding Handstand Push-up Negative", criterion: { type: "reps", metric: "freestanding_hspu_negative", min: 5 }, dose: { sets: 5, reps: "3-5", rest: "3 min", rir: "0", frequency_per_week: 2 }, complementary: ["Freestanding Handstand Hold"] },
      { name: "Freestanding Handstand Push-up", criterion: { type: "reps", metric: "freestanding_hspu", min: 3 }, dose: { sets: 5, reps: "1-3", rest: "3-4 min", rir: "0", frequency_per_week: 2 }, complementary: [] },
      { name: "90-Degree Freestanding Handstand Push-up", criterion: { type: "reps", metric: "freestanding_90_hspu", min: 1 }, dose: { sets: 5, reps: "1-2", rest: "4 min", rir: "0", frequency_per_week: 2 }, complementary: [] },
    ],
  },
  // ---- ONE-ARM PULL-UP -------------------------------------------------
  {
