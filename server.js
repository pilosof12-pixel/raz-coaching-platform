...
const INTAKE_HANDLING_RULES = [
  ...
  "- 'training_location' is one of: 'commercial_gym', 'home_gym', 'garage_gym', 'outdoor_park', 'hotel_room', 'home_bodyweight'. See LOCATION_EQUIPMENT_RULES — the location further constrains what equipment can plausibly be present. Effective equipment = intersection of intake.equipment and the location's whitelist. Never program a movement whose required gear falls outside that intersection.",
  "- 'language' is a string, 'en' (default) or 'he' (Hebrew). See LOCALIZATION_RULES — when it is 'he', all client-facing prose, exercise names and Notes must be written in Hebrew while structural TSV tokens stay in English.",
...
const WARMUP_CEILING_RULES = [
  ...
  "  - Warm-up cell containing 'Box Pike Push-Up' at working depth, 'Deficit Wall HSPU', or '90-Degree Wall HSPU' when the working exercise is 'Wall Handstand Push-Up'.",
